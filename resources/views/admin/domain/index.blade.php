<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-800">Domains</h2>
            <a href="{{ route('domain.create') }}" class="bg-indigo-600 text-white px-4 py-2 rounded inline-block hover:bg-indigo-700 transition-colors">
                + Add New Domains
            </a>
        </div>
    </x-slot>
