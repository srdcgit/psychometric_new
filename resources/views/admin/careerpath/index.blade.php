<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-800">Career Path</h2>
            <a href="{{ route('careerpath.create') }}" class="bg-indigo-600 text-white px-4 py-2 rounded inline-block hover:bg-indigo-700 transition-colors">
                + Add New Career Path
            </a>
        </div>
    </x-slot>
                            ...
                            @foreach ($careerpaths as $career)
                                <tr class="border-b">
                                    ...
                                    <td class="px-4 py-2 space-x-2">
                                        ...
                                        <form action="{{ route('careerpath.destroy', $career->id) }}" method="POST"
