...
<div class="container max-w-5xl py-5">
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-5">
        ...
        <a href="{{ route('assessment.report.pdf') }}"
            class="btn btn-dark btn-lg px-4 shadow-sm">Download PDF</a>
    </div>
    ...
    <div class="mb-5">
        ...
        <p class="lead">This report is a comprehensive analysis of {{ $student->name }}'s personality traits, career interests, learning preferences, work values, future orientation, and cognitive aptitude. The aim is to provide holistic guidance to support academic planning, skill development, and long-term career alignment.</p>
    </div>

    <div class="mb-5">
        <h2 class="h3 fw-semibold text-secondary mb-3">Overview of Tools</h2>
        <ul class="list-group list-group-flush small">
            <li class="list-group-item"><strong>Holland Code (RIASEC):</strong> Explores personality-job match across six vocational types.</li>
            ...
            <li class="list-group-item"><strong>Work Values Inventory:</strong> Measures motivational drivers in professional settings.</li>
            <li class="list-group-item"><strong>Goal Orientation:</strong> Evaluates temporal preference (long vs short-term goals).</li>
            <li class="list-group-item"><strong>Aptitude Profile:</strong> Analyzes reasoning and cognitive abilities.</li>
        </ul>
    </div>
    ...
    @foreach ($groupedResults as $domainName => $sections)
        ...
        <section class="mb-5">
            <h2 class="h4 fw-semibold text-primary mb-4">{{ $domainName }}</h2>
                    ...
                    <article class="col-md-12 col-lg-6">
                        <div class="card border-primary shadow-sm rounded-4 h-100">
                            <div class="card-body">
                                ...
                                @if ($domainName === 'OCEAN')
                                    <p class="small mt-2"><strong>{{ $section['label'] }}:</strong> {{ $section['relevant_description'] }}</p>
                                ...
                                @else
                                    <div class="small mt-3">
                                        ...
                                        <p><strong>Ideal Environments:</strong> {{ $section['section_idealenvironments'] }}</p>
                                    </div>
                                @endif
                            </div>
                        </div>
    ...
    <section class="mt-5">
        ...
        <p class="lead text-muted">{{ $student->name }} demonstrates high emotional stability, creativity, conscientiousness, and social engagement. His preference for autonomy and long-term orientation aligns well with careers requiring deep engagement and self-direction.</p>
    </section>
    ...
    <section class="mt-5">
        ...
        @php
            ...
            $categoryDetails = \App\Models\CareerCategory::whereIn('name', array_keys($overallCategoryWeightages))->get()->keyBy('name');
        @endphp
    ...
    <section class="mt-5">
        ...
        <p class="lead text-muted">{{ $student->name }} exhibits a balanced and mature personality marked by self-awareness and goal clarity. With his cognitive strengths and humanistic values, he can lead in fields that demand both intellect and empathy. Encouraging exploratory learning and mentorship will enrich his trajectory.</p>
